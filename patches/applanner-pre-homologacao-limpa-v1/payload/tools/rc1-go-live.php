...
$add('Homologação','Sem tenants de demonstração',$demoTenants===0,$demoTenants.' tenant(s) demo instalado(s)');
$demoBilling=0;
if($demoColumn){
...
$add('Homologação','Sem billing de demonstração',$demoBilling===0,$demoBilling.' registro(s) de billing em tenant demo','warning');
