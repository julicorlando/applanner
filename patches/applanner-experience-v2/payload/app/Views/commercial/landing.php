...
$ctaLabel=trim((string)($growth['cta_label']??''))?:($plans?\App\Core\I18n::t('landing.cta'):'Falar com um consultor');
$trialDays=$plans?max(array_map(fn($p)=>(int)($p['trial_days']??0),$plans)):0;
$heroTitle=trim((string)($growth['hero_title']??''))?:\App\Core\I18n::t('landing.title');$heroSubtitle=trim((string)($growth['hero_subtitle']??''))?:\App\Core\I18n::t('landing.subtitle');$pixelId=preg_match('/^\d{5,30}$/',(string)($growth['meta_pixel_id']??''))?(string)$growth['meta_pixel_id']:'';
?>
<div class="conversion-page showcase-home" data-meta-pixel-id="<?=$e($pixelId)?>">
<section class="conversion-hero showcase-hero">
  <div class="conversion-copy">
    <span class="conversion-pill"><?=$e(\App\Core\I18n::t('landing.pill'))?></span>
    <h1><?=$e($heroTitle)?></h1>
    <p><?=$e($heroSubtitle)?></p>
    ...
    <div class="conversion-reassurance">
      <?php if($plans&&$trialDays):?><span>✓ <?=$e(\App\Core\I18n::t('landing.trial',['days'=>$trialDays]))?></span><?php endif;?>
      <span>✓ <?=$e(\App\Core\I18n::t('landing.guided'))?></span><span>✓ <?=$e(\App\Core\I18n::t('landing.devices'))?></span><span>✓ <?=$e(\App\Core\I18n::t('landing.modules'))?></span>
    </div>
  </div>
...
</div><script src="/public/assets/js/index-conversion.js?v=20260826-prehomologacao" defer></script><script src="/public/assets/js/growth-tracking.js?v=1" defer></script>
