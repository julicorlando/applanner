...
$q=$pdo->query("SELECT id FROM tenants WHERE deleted_at IS NULL AND status IN('trial','active') AND LOWER(TRIM(category)) IN('lava_jato','lava-jato','lava jato','detailing','estetica automotiva','estética automotiva','automotivo','automotive','auto')");
