...
SPECS=[
    ...
    {"table":"data_import_jobs","model":"operations.DataImportJob","rename":{"summary":"summary_json"}},\n    {"table":"jobs","model":"operations.LegacyRuntimeJob"},\n    {"table":"jobs_failed_archive","model":"operations.LegacyFailedJobArchive"},\n    {"table":"migrations","model":"operations.LegacyMigrationRecord"},
    ...
    {"table":"sports_reservations","model":"arena.Reservation","rename":{"pricing_details":"pricing_details_json","legacy_tournament_match_id":"tournament_match_id"}},
        ...
        for row in self._rows(conn,table):
            ...
            obj,_=Model.objects.update_or_create(
                ...
                defaults={
                    ...
                    "environment":row.get("environment") or "sandbox",
                    "auth_type":row.get("auth_type") or "api_credentials",
