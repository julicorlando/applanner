...
<section class="conversion-hero showcase-hero">
  <div class="conversion-copy">
    ...
    <div class="conversion-actions">
      ...
      <a class="btn btn-outline-light btn-lg" href="/auto/applanner-auto-demo">Ver demonstração Auto</a>
    </div>
...
<div class="segment-result"><div><span data-segment-kicker>Para lava-jato e detailing</span><h3 data-segment-title>Do check-in do veículo à próxima manutenção.</h3><p data-segment-text>Organize carros, boxes, serviços, checklist, orçamento, estoque e retorno do cliente em um fluxo único.</p><ul data-segment-list><li>Veículos e histórico por placa</li><li>Boxes, check-in e etapas</li><li>Comanda, garantia e CRM</li></ul><div class="segment-inline-actions"><a class="btn btn-primary btn-lg" href="<?=$cta?>">Aplicar no meu negócio</a><a class="btn btn-outline-primary btn-lg" data-segment-demo href="/auto/applanner-auto-demo">Ver demo</a></div></div>
...
<section class="conversion-section demo-commercial-banner"><div><span class="conversion-eyebrow">Demonstração pronta</span><h2>Conheça o ApPlanner Auto com dados de uma operação completa.</h2><p>A demonstração possui funcionários, clientes, carros, boxes, serviços e histórico para você navegar pelo fluxo antes de contratar.</p></div><div><a class="btn btn-light btn-lg" href="/auto/applanner-auto-demo">Abrir página do cliente</a><a class="btn btn-outline-light btn-lg" href="<?=$cta?>">Quero meu ambiente</a></div></section>
...
<section class="conversion-final"><span>Seu negócio já tem uma operação. O ApPlanner ajuda você a enxergá-la.</span><h2>Organize hoje. Adicione recursos conforme crescer.</h2><p>Teste o fluxo, conheça a demonstração e escolha a configuração que faz sentido para sua empresa.</p><div><a class="btn btn-light btn-lg" href="<?=$cta?>"><?=$e($ctaLabel)?> →</a><a class="btn btn-outline-light btn-lg" href="/auto/applanner-auto-demo">Ver Auto Demo</a></div><small>Ao continuar, você poderá consultar os Termos de Uso e a Política de Privacidade.</small></section>
...
</div><script src="/public/assets/js/index-conversion.js?v=20260818-showcase" defer></script>
