...
use App\Services\{BehaviorEngine,ModuleService,ArenaTenantService};
...
final class DashboardController
{
    public function index(): void
    {
        ...
        $t=$pdo->prepare('SELECT name,public_slug,public_short_code,public_enabled FROM tenants WHERE id=:t');$t->execute(['t'=>$tenantId]);$tenant=$t->fetch();
        View::render('dashboard/index',['title'=>'Dashboard','stats'=>$stats,'opportunities'=>$opportunities,'upcoming'=>$stmt->fetchAll(),'tenant'=>$tenant,'behaviorEnabled'=>$behaviorEnabled,'productsEnabled'=>ModuleService::has('products',$tenantId)]);
    }
